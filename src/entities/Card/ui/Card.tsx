...
export const Card = ({
  ...
  //   return (
  //     <div
  //       style={{ backgroundImage: `url(${BackHand.src})` }}
  //       className={`${classes.back} relative rotate-2 rounded-2xl shadow-md w-[330px] h-[515px] flex items-center justify-center bg-no-repeatbg-center bg-cover noise-overlay`}
  //     >
  //       <ComeCloserLogoBack className={`h-[23%] aspect-square`} />
  //     </div>
  //   )
  ...
  return (
    <motion.div
      ...
      // className={`${classes.container} py-11 px-10 rotate-2 rounded-2xl shadow-md w-[330px] h-[515px] flex flex-col justify-between items-center noise-overlay relative`}
      // style={{}}
      drag="x"
